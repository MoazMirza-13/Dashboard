...
export const graphChart = async () => {
  const url1 =
    "https://www.randomnumberapi.com/api/v1.0/random?min=20&max=100&count=6";
  const url2 =
    "https://www.randomnumberapi.com/api/v1.0/random?min=20&max=100&count=6";
...
export const barChart = async () => {
  const url1 =
    "https://www.randomnumberapi.com/api/v1.0/random?min=150&max=380&count=9";
  const url2 =
    "https://www.randomnumberapi.com/api/v1.0/random?min=150&max=300&count=9";
  const url3 =
    "https://www.randomnumberapi.com/api/v1.0/random?min=150&max=350&count=9";
...
export const dailyTrafficChart = async () => {
  const url1 =
    "https://www.randomnumberapi.com/api/v1.0/random?min=15&max=60&count=7";
  const url2 =
    "https://www.randomnumberapi.com/api/v1.0/random?min=2&max=10&count=1";
  try {
    const response1 = await axios.get(url1);
    const response2 = await axios.get(url2);
    return {
